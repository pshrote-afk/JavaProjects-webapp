...
jsonObject.addProperty("message","Student with roll no " + student.getRollNo() + " successfully updated!");
...
jsonObject.addProperty("message","Error while updating student: " + blException.getGenericException());
