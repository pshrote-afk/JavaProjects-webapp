...
public class GetAllStudents extends HttpServlet {
  public void doGet(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      // manually creating object and adding so that java.util.Date is formatted to dd-MM-yyyy. Else
      // it is sending date in format "Thu 31 Jan 12:00:00 AM" to frontend
